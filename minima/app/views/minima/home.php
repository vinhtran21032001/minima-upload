          ...
          <?php foreach($this->data as $row): ?> 
            <div class="background-white full-width"> 
              <div class="s-12 m-6 l-five">
                <a class="image-with-hover-overlay image-hover-zoom" href="<?=ROOT . './singlePost/index/'  .$row->image_url; ?>" title="Portfolio Image">
                  ...
                  <img class="full-img" src="<?=ROOT .$row->image_address; ?>" alt=""/>
                </a>	
              </div>
